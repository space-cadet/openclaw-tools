...
- Node: `~/.nvm/versions/node/v23.11.0/bin/node` (or your Node path)
- NPM: `~/.nvm/versions/node/v23.11.0/bin/npm` (or your NPM path)
- PNPM: `~/.nvm/versions/node/v23.11.0/bin/pnpm` (or your PNPM path)
- Python: `~/miniconda3/bin/python` (or your Python path)
