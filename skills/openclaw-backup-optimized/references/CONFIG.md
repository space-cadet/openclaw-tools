...
- `BACKUP_REPO_URL`: git repo for push (e.g., https://github.com/your-username/openclaw-backup.git)
- `BACKUP_CHANNEL_ID`: Discord channel id for notifications (optional)
- `BACKUP_TZ`: timezone (default UTC)
...
0 5,10,15,20 * * * (adjust timezone as needed)
